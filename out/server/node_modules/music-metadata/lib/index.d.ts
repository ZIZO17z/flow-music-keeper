...
import * as Core from 'music-metadata/lib/core';
import { IAudioMetadata, IOptions } from 'music-metadata/lib/type';
export { IAudioMetadata, IOptions, ITag, INativeTagDict, ICommonTagsResult, IFormat, IPicture, IRatio, IChapter } from 'music-metadata/lib/type';
export { parseFromTokenizer, parseBuffer, IFileInfo, selectCover } from 'music-metadata/lib/core';
/**
